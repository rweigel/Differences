...
int main (int argc, char * argv[]){
	...
	for ( runi = 0; runi < 24; runi++){
		...
		dirstring = "/mnt/Disk2/"; dirstring.append(chooserun[dset1[runi]]); dirstring.append("/GM_CDF");
		...
		dirstring3 = "/mnt/Disk2/"; dirstring3.append(chooserun[dset2[runi]]); dirstring3.append("/GM_CDF");
	    ...
	    for(loopnum=0; loopnum<run1ls.size(); loopnum++ ){
			...
			resultfilename = "/mnt/Disk2/Results/";
